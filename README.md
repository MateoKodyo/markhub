...
2. **Copie les 4 fichiers** de ce pack à la racine :
...
4. **Premier message à donner à Claude Code** :
   ```
   Lis SPEC.md, TESTS.md, PLAN.md et CLAUDE.md.
   Confirme que tu as compris la mission et lance la Phase 0.
   ```

5. **Ton seul boulot** : valider à chaque GATE. Claude Code s'arrête tout seul, te montre un récap, attend ton OK. Tu réponds « ok » ou « lance la phase suivante » et il continue. Tu peux aussi tester l'app entre les phases (à partir de la phase 3) pour valider visuellement.
